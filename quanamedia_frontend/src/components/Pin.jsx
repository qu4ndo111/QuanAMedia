            ...
            <div className='flex justify-between items-center gap-2 w-full'>
              {destination && (
                ...
                >
                  ...
                  {destination.length > 15 ? `${destination.slice(0, 15)}...e` : destination}
                </a>
              )}
              {postedBy?._id === user?.sub && (
                <button type='button'
                  ...
                  className='bg-white-500 p-2 opacity-70 hover:opacity-100 text-dark font-bold py-1 text-base rounded-full hover:shadow-md outlined-none'
                >
                  <AiTwotoneDelete />
                </button>
              )}
